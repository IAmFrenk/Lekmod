...
public:
	...
	void PerformCultureBomb(int iRadius, int iRadiusNeutral, int iMaxRadiusFromOwnedCities);
	void PerformCultureBombInternal(int iRadius, int iMaxRadiusFromOwnedCities, bool iNeutralTilesOnly);
